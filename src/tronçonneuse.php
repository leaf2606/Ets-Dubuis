...
<body>
    ...
    <div id="news-lien-id">
        <div class="lien-news">
            <button class="lien-nouveautes" onclick="openTab('cs')">CS</button>
    ...
    <div id="cs" class="card-container">
        <h1 class="titre-categorie">Tronçonneuse CS</h1>
        <div class="wrapper-vetements">
            <div class="card-area">
                <div class="box-area">
                    <?php foreach ($catalogue as $item): ?>
                    <?php if ($item['category'] === 'cs'): ?>
                    <div class="box">
    ...
    <div id="dhc" class="card-container">
        <h1 class="titre-categorie">Tronçonneuse dhc</h1>
        <div class="wrapper-vetements">
            <div class="card-area">
                <div class="box-area">
                    <?php foreach ($catalogue as $item): ?>
